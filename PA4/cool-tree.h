...
public:
   ...
   void dump(ostream& stream, int n);
   Expression get_expr() const { return expr; }
   Symbol get_type_name() const { return type_name; }
   Symbol get_name() const { return name; }
   Expressions get_actual() const { return actual; }
...
public:
   ...
   Expression get_then_exp() const { return then_exp; }
   Expression get_else_exp() const { return else_exp; }
...
public:
   ...
   Expression get_expr() const { return expr; }
   Cases get_cases() const { return cases; }
...
public:
   ...
   Symbol get_identifier() const { return identifier; }
   Symbol get_type_decl() const { return type_decl; }
   Expression get_init() const { return init; }
   Expression get_body() const { return body; }
